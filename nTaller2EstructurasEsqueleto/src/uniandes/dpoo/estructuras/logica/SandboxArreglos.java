...
public class SandboxArreglos
{
    ...
    public void eliminarEntero( int valor )
    {
    	...
    	int longitud = arregloEnteros.length - cantidad;
    ...
    public void eliminarCadena( String cadena )
    {
    	...
    	{
    		if (i == cadena) cantidad++;
    	}
    	int longitud = arregloCadenas.length - cantidad;
    	
    	String[] nuevoArreglo = new String [longitud];
    	int posicion = 0;
    	for (String numero : arregloCadenas) {
    		if (numero != cadena) {
    			nuevoArreglo[posicion++] = cadena;
    		}
    ...
    public void eliminarEnteroPorPosicion( int posicion )
    {
    	...
    	int[]nuevoArreglo = new int[arregloEnteros.length -1];
    	for (int pn = 0, pv = 0; pn < arregloEnteros.length; pn++) {
    		if (pn != posicion) {
    			nuevoArreglo[pv++] = arregloEnteros[pn];
    		}
    	}
    	arregloEnteros = nuevoArreglo;
    }
    ...
    public int contarEnterosRepetidos( )
    {
        ...
        int count = 0;
        for (int freq : histograma.values())
        {
            if (freq > 1) count++;
        }
        return count;
